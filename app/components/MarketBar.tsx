...
function Tickern({market}: {market: string}) {
    ...
    return <div className="flex h-[60px] shrink-0 space-x-4">
        <div className="flex flex-row relative ml-2 -mr-4">
            <img alt="SOL Logo" loading="lazy" decoding="async" data-nimg="1" className="z-10 rounded-full h-6 w-6 mt-4 outline-baseBackgroundL1"  src={`https://backpack.exchange/_next/image?url=%2Fcoins%2F${market.split('_')[0].toLowerCase()}.png&w=32&q=75`} />
